...
class BalanceService:
    ...
    def get_financial_summary(db):
        ...
        # 1. 现金 (Flowing Cash) - 改为直接从具体的现金账户资产累加
        ...
        return {
            "cash_items": cash_items, # 新增暴露现金明细
            ...
            "equities": equities,
            "totals": {
                "pure_asset": {"CNY": pure_asset_cny, "JPY": pure_asset_jpy}, # 非现金资产
                "asset": {"CNY": total_asset_cny, "JPY": total_asset_jpy},     # 现金+资产
